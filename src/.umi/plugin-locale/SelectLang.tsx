 ...
 const handleClick = onItemClick
  ...
  const langMenu = (
    ...
    >
        ...
        <Menu.Item key={'id-ID'} style={menuItemStyle}>
          <span role='img' aria-label={allLangUIConfig['id-ID']?.label  || 'id-ID'}>
            {allLangUIConfig['id-ID']?.icon || "🌐"}
          </span>{' '}
          {allLangUIConfig['id-ID']?.label || 'id-ID'}
        </Menu.Item>
